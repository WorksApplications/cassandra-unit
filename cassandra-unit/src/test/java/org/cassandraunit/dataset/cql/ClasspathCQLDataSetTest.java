...
public class ClasspathCQLDataSetTest {
    ...
    public void shouldGetCQLQueries() {
        ...
        assertThat(dataSet.getCQLStatements().get(0), is("CREATE TABLE IF NOT EXISTS test_cql_table (id uuid, value varchar, PRIMARY KEY(id));"));
        assertThat(dataSet.getCQLStatements().get(1),is("INSERT INTO test_cql_table(id, value) values(1690e8da-5bf8-49e8-9583-4dff8a570737,'Cql loaded string');"));
        assertThat(dataSet.getCQLStatements().get(2),is("INSERT INTO test_cql_table(id, value) values(1690e8da-5bf8-49e8-9583-4dff8a570738,'BLA2');"));
        assertThat(dataSet.getCQLStatements().get(3),is("INSERT INTO test_cql_table(id, value) values(1690e8da-5bf8-49e8-9583-4dff8a570739,'BLA1');"));
    }
    ...
    public void shouldGetCQLQueriesFromMultiLineCQLScript() {
        ...
        assertThat(dataSet.getCQLStatements().isEmpty(), is(false));
        assertThat(dataSet.getCQLStatements().size(),is(4));
        assertThat(dataSet.getCQLStatements().get(0),is("CREATE TABLE test_cql_table ( id uuid, value varchar, PRIMARY KEY(id) );"));
        assertThat(dataSet.getCQLStatements().get(1),is("INSERT INTO test_cql_table(id, value) values(1690e8da-5bf8-49e8-9583-4dff8a570737,'Cql loaded string');"));
        assertThat(dataSet.getCQLStatements().get(2),is("INSERT INTO test_cql_table( id,value ) values( 1690e8da-5bf8-49e8-9583-4dff8a570738, 'BLA2' );"));
        assertThat(dataSet.getCQLStatements().get(3),is("INSERT INTO test_cql_table(id, value) values(1690e8da-5bf8-49e8-9583-4dff8a570739,'BLA1');"));
    }
